...
import com.kyc.business.customer.Customer;
import com.kyc.business.customer.CustomerRepository;

@SpringBootApplication
public class TestproApplication {

	private static final Logger log = LoggerFactory.getLogger(TestproApplication.class);
